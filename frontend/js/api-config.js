...
// Note: HTTP is used for localhost (standard practice for local development), HTTPS for production
const API_BASE_URL = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
    ? 'http://localhost:5000/api'
    : (window.PYTHONANYWHERE_USERNAME && /^[a-zA-Z0-9-]+$/.test(window.PYTHONANYWHERE_USERNAME)
